...
const domains_for_dl = ['https://sweets.bangladeshhoarding.workers.dev', 'https://roshmalai.bdh.workers.dev', 'https://ramyeon.indexbdh.workers.dev']; // add multiple cloudflare addresses to balance the load on download/stream servers, eg. ['https://testing.fetchgoogleapi.workers.dev', 'https://testing2.fetchgoogleapi2.workers.dev']
...
const authConfig = {
    "siteName": "I N D E X B D", // Website name
    ...
    "search_result_list_page_size": 20,
    ...
    "roots":[
      {
          ...
          //"auth": {"bdh@admin":"alexstuart"} /* Remove double slash before "auth" to activate id password protection */
      },
      {
      ...
      {
          "id": "0AIuIJuGBPFRfUk9PVA",
          "name": "BNC.BDH",
          "protect_file_link": false,
          //"auth": {"bdh@admin":"alexstuart"} /* Remove double slash before "auth" to activate id password protection */
      }, 
      {
          "id": "0AIqqdDdI8totUk9PVA",
          "name": "Clone-Dump",
          "protect_file_link": false,
          //"auth": {"bdh@admin":"alexstuart"} /* Remove double slash before "auth" to activate id password protection */
      },
...
const uiConfig = {
    ...
    "version": "2.1.7alx6m", // don't touch this one. get latest code using generator at https://bdi-generator.hashhackers.com
    ...
    "logo_link_name": "https://cdn.jsdelivr.net/gh/noob-af-bd/IndexBD@2.1.7alx2/assets/indexbd_small_logo.svg",
    ...
    "home_link_bdh": "https://indexbd.xyz", // Base URL Of Index
    "nav_link_1": "Home", // change navigation 1st Button Name link name
    "nav_link_1_link": "https://indexbd.xyz", //change navigation 1st Button Name 
    "nav_link_3": "Bangladesh Hoarding", // change navigation 2nd Button Name 
    "nav_link_3_link": "https://t.me/BangladeshHoarding", // change navigation 2nd Button link
    "nav_link_4": "Content Request", // change navigation 3rd Button Name
    "contact_link": "https://t.me/BDH_PM_bot", //change navigation 3rd Button Nam link
    ...
    "poster": "https://i.ibb.co/ZMX2Ryj/GH526az-H-1.png", // Video poster URL or see Readme to how to load from Drive
    "audioposter": "https://cdn.jsdelivr.net/gh/noob-af-bd/IndexBD@2.1.7alx2/assets/indexbd.svg", // Video poster URL or see Readme to how to load from Drive
    "jsdelivr_cdn_src": "https://cdn.jsdelivr.net/gh/noob-af-bd/IndexBD", // If Project is Forked, then enter your GitHub repo
    "render_head_md": true, // Render Head.md
    "render_readme_md": true, // Render Readme.md https://cdn.jsdelivr.net/gh/noob-af-bd/IndexBD
    ...
    "footer_text": "-বিনোদন হোক ঝামেলাহীন-", 
    "footer_text_links": "https://t.me/bangladeshHoarding",
    "footer_text_links_text": "BDH"
};
...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/gh/noob-af-bd/IndexBD@2.1.7alx6m/js/app-multiple-drives.obf.js"></script>
...
<body>
  ...
  <!-- Messenger Chat Plugin Code -->
    ...
    <script>
      ...
      chatbox.setAttribute("page_id", "113184418058084");
...
<html>
   ...
   <body>
         ...
         <div id="nav">
            <nav class="navbar navbar-expand-lg${uiConfig.fixed_header ?' fixed-top': ''} ${uiConfig.header_style_class}">
               <div class="container-fluid">
                 <a class="navbar-brand" href="${uiConfig.home_link_bdh}">${uiConfig.logo_image ? '<img border="0" alt="'+uiConfig.company_name+'" src="'+uiConfig.logo_link_name+'" height="'+uiConfig.height+'" width="'+uiConfig.logo_width+'">' : uiConfig.logo_link_name}</a>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                          <a class="nav-link" href="${uiConfig.nav_link_1_link}">${uiConfig.nav_link_1}</a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" href="${uiConfig.contact_link}" target="_blank">${uiConfig.nav_link_4}</a>
                        </li>                        
                        <li class="nav-item">
                           <a class="nav-link" href="${uiConfig.nav_link_3_link}" target="_blank">${uiConfig.nav_link_3}</a>
                        </li>
      ...
      <div>
               ...
               <div class="alert alert-primary d-flex align-items-center" role="alert" style="margin-bottom: 0; padding-bottom: 0rem;">
                  <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                     <ol class="breadcrumb" id="folderne">
                        <li class="breadcrumb-item"><a href="${uiConfig.home_link_bdh}">Home</a></li>
                     </ol>
                  </nav>
               </div>
         ...
         <br>
         <footer class="footer mt-auto py-3 text-muted ${uiConfig.footer_style_class}" style="${uiConfig.fixed_footer ?'position: fixed; ': ''}left: 0; bottom: 0; width: 100%; color: white; z-index: 9999;${uiConfig.hide_footer ? ' display:none;': ' display:block;'}"> <div class="container" style="width: auto; padding: 0 10px;"> <p class="float-end"> <a href="#" style="text-decoration: none">Back to top</a> </p><p> ${uiConfig.footer_text} -<a href="${uiConfig.footer_text_links}" style="text-decoration: none">${uiConfig.footer_text_links_text}</a></p> <p>© ${uiConfig.copyright_year} - <a href=" ${uiConfig.company_link}" style="text-decoration: none"> ${uiConfig.company_name}</a>, All Rights Reserved.</p> </div> </footer>
      </div>
   </body>
...
<html lang=en>
  ...
  <meta property="og:image" content="https://i.imgur.com/58EPYPB.png"/>
  <style>
    *{margin:0;padding:0}html,code{font:15px/22px arial,sans-serif}html{background:#fff;color:#222;padding:15px}body{margin:7% auto 0;max-width:390px;min-height:180px;padding:30px 0 15px}* > body{background:url(//www.google.com/images/errors/robot.png) 100% 5px no-repeat;padding-right:205px}p{margin:11px 0 22px;overflow:hidden}ins{color:#777;text-decoration:none}a img{border:0}@media screen and (max-width:772px){body{background:none;margin-top:0;max-width:none;padding-right:0}}#logo{background:url(//https://cdn.jsdelivr.net/gh/noob-af-bd/IndexBD@2.1.7alx2/assets/indexbd_small_logo.svg) no-repeat;margin-left:-5px}@media only screen and (min-resolution:192dpi){#logo{background:url(//https://cdn.jsdelivr.net/gh/noob-af-bd/IndexBD@2.1.7alx2/assets/indexbd_small_logo.svg) no-repeat 0% 0%/100% 100%;-moz-border-image:url(//https://cdn.jsdelivr.net/gh/noob-af-bd/IndexBD@2.1.7alx2/assets/indexbd_small_logo.svg) 0}}@media only screen and (-webkit-min-device-pixel-ratio:2){#logo{background:url(//https://cdn.jsdelivr.net/gh/noob-af-bd/IndexBD@2.1.7alx2/assets/indexbd_small_logo.svg) no-repeat;-webkit-background-size:100% 100%}}#logo{display:inline-block;height:54px;width:150px}
  </style>
...
"The requested URL <code>" + window.location.pathname + "</code> was not found on this server.  <ins>That’s all we know.</ins>";
  ...
  <div class="container">
  <div class="content">
  <div class="message">Access Denied- IndexBD is not available in your region or Turn off your VPN.</div>
  </div>
  </div>
  </body>
  </html>`
  ...
  <div class="container">
  <div class="content">
  <center><b>ইনডেক্স বিডি'তে আপনাকে স্বাগতম</b><br><a href="https://indexbd.xyz"><img src="https://cdn.jsdelivr.net/gh/noob-af-bd/IndexBD@2.1.7alx2/assets/indexbd.svg" alt="I N D E X B D" border="0" height="100px" width="100%" style="margin-top: 10px;"></a><br><b>"বিনোদন হোক ঝামেলাহীন"</b><br><br></center>
  <div class="message">Direct Link Generated ..Use the below Button to get your files....</div>
  <center><a href=""><button class="btn btn btn-danger">Click Here to Processed!</button></a></center>
  </div>
  </div>
  </body>
  </html>
